    ...
    public partial class TravelHistoryControl : UserControl
    {
        ...
        private void AddNewHistoryRow(bool insert, VisitedSystemsClass item)            // second part of add history row, adds item to view.
        {
            ...
            if (insert)
            {
                ...
                SystemClass s = item.curSystem as SystemClass;

                s.status = SystemStatusEnum.EDDiscovery;
                s.CommanderCreate = GetCommanderName();
        ...
        {
            List<string> cmdrs = SystemClass.GetAllFirstDiscoveryCommanders();
